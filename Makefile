...
.PHONY: go-test go-coverage webapp-test webapp-coverage webapp-lint webapp-typecheck webapp-build package
...
webapp-test: webapp/node_modules
	cd webapp && $(NPM) run test -- --runInBand

webapp-coverage: webapp/node_modules
	cd webapp && $(NPM) run test:coverage

webapp-lint: webapp/node_modules
	cd webapp && $(NPM) run lint

webapp-typecheck: webapp/node_modules
	cd webapp && $(NPM) run check-types

webapp-build: webapp/node_modules
...
## Creates coverage reports for the server and webapp code.
.PHONY: coverage
coverage: go-coverage webapp-coverage
