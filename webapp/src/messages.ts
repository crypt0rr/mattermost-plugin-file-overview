...
export const messages = {
    ...
    sharedInMessage: 'Shared in message',
    attachmentCount: '{count} files in this message',
    loadingMessageContext: 'Loading message context…',
    messageContextUnavailable: 'Message context unavailable.',
    noMessageText: 'No message text',
    open: 'Open file',
    preview: 'Preview file',
    previewNavigation: 'Preview navigation',
    previewPosition: '{current} of {total}',
    previewUnavailable: 'This file cannot be previewed in the browser.',
